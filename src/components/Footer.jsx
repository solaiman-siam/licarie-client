import footerLogo from "../../src/assets/images/licarie-logo.png";
            ...
            <div className="grid grid-cols-1 gap-8 lg:col-span-2 sm:grid-cols-2 lg:grid-cols-4">
              <div>
                ...
                <nav className="flex flex-col mt-4 space-y-2 text-sm cursor-pointer text-gray-500">
                  ...
                  <a className="hover:text-[#F9BF56]"> Careers </a>
                </nav>
              </div>
              <div>
                ...
                <nav className="flex flex-col mt-4 space-y-2 cursor-pointer text-sm ">
                  ...
                  <a className="hover:text-[#F9BF56]"> SEO Optimisation </a>
                </nav>
              </div>
              <div>
              ...
              <div>
                ...
                <nav className="flex cursor-pointer flex-col mt-4 space-y-2 text-sm text-gray-500">
                  ...
                  <a className="hover:text-[#F9BF56]"> Returns Policy </a>
                  <a className="hover:text-[#F9BF56]"> Accessibility </a>
                </nav>
              </div>
            </div>
          </div>
